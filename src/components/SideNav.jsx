...
export const SideNav = ({ user }) => {
  ...
  return (
    <div className="flex flex-col h-screen border-r py-20 w-80 bg-slate-100">

      {/* Navigation */}
      <nav className="flex-1 px-4 py-6 space-y-4">
        <a
          href="/dashboard"
          className={`flex items-center space-x-2 ${pathname === '/dashboard/home' ? 'text-blue-600' : 'text-gray-600'} hover:text-blue-600`}
        >
        ...
        <a
          ...
          className={`flex items-center space-x-2 ${pathname === '/dashboard/wallet' ? 'text-blue-600' : 'text-gray-600'} hover:text-blue-600`}
        >
        ...
        <a
          ...
          className={`flex items-center space-x-2 ${pathname === '/dashboard/expenses' ? 'text-blue-600' : 'text-gray-600'} hover:text-blue-600`}
        >
